...
void zanderfish_cbc_encrypt(unsigned char * msg, int msglen, unsigned char * key, int keylen, unsigned char * iv, int ivlen) {
    uint32_t xl;
    uint32_t xr;
...
void zanderfish_cbc_decrypt(unsigned char * msg, int msglen, unsigned char * key, int keylen, unsigned char * iv, int ivlen) {
    uint32_t xl;
    uint32_t xr;
    int blocks = msglen / blocklen;
    int extra = msglen % blocklen;
